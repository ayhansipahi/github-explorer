...
export type RepoSearchResponse = RepoSearchSuccess | RepoSearchFail;

export interface RepoSearchSuccess {
  total_count: number;
...
export type RepoSearchRequestParams = {
    q: string;
    sort?: RepoSortOptions;
    order?: RepoSortDirection;
    page?: string;
    per_page?: string;
};

// stars, forks, help-wanted-issues, updated
export type RepoSortOptions = "stars" | "forks" | "help-wanted-issues" | "updated";
